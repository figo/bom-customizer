...
# Given a component name, fully replace its values.
...
function help() {
  ...
  echoerr "   -v, --value <yaml_string>:        the new YAML value for the component as a string"
  echoerr "   -f, --value-file <filename>:      the filename which contains the new YAML value for the component"
  exit "$1"
}
